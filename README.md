...
* tests four parameter configurations; the model uses 18 trees, [max_depth=7](https://xgboost.readthedocs.io/en/stable/parameter.html), [min_child_weight=20](https://xgboost.readthedocs.io/en/stable/parameter.html), [subsample=0.75](https://xgboost.readthedocs.io/en/stable/parameter.html), and [colsample_bytree=0.90](https://xgboost.readthedocs.io/en/stable/parameter.html)
